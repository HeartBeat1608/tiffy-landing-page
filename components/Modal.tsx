...
const Modal = ({ open, onClose }: Props) => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 bg-gray-500/50 flex items-center justify-center">
        <div className="min-w-[220px] max-w-md bg-white rounded-md p-8 space-y-4">
