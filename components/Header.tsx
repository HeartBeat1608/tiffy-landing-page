    ...
    <div className="bg-white w-full" id="header">
      <div className="flex justify-between items-center w-full container mx-auto pt-4 pb-8 px-6 md:px-0">
        ...
        <nav className="flex items-center justify-center gap-6">
          <a className="hover:text-emerald-500 hover:font-bold duration-300 cursor-pointer" href="#header">Home</a>
          <a className="hover:text-emerald-500 hover:font-bold duration-300 cursor-pointer" href="#about">Why Tiffy?</a>        
          </nav>
